...
Nel momento in cui individuo dei marcatori tumorali posso identificare singole cellule in maniera molto efficiente marcandole con un particolare Ab monoclonale. Questo mi permette eventualmente di isolarle usando tecniche di sorting specifico (per sorting intendiamo dei citofluorimetri separatori che separano le particelle fluorescenti). Posso così identificare anche singole cellule in un tessuto sano, e quindi vedere precocemente se le cellule tumorali hanno infiltrato un certo tessuto e prevenire la diffusione di metastasi. Le potenzialità sono enormi, anche perché ormai si è capito che è difficile fare prevenzione, i tumori sono causati da mutazioni casuali.

Razionale della tecnologia degli ibridomi per la produzione di anticorpi monoclonali
Si costruiscono degli ibridi somatici intraspecifici che si chiamano ibridomi. La logica è molto semplice e si basa sul concetto di complementazione genetica: prendo due linee cellulari che hanno caratteristiche diverse, le metto insieme e ottengo una nuova linea cellulare, l’ibridoma, che somma in sé stessa le caratteristiche di entrambe le linee cellulari parentali. Ovviamente devo eliminare tutti i parentali 1 e 2, per avere alla fine esclusivamente le cellule che conservano per complementazione le caratteristiche di entrambe le linee cellulari. 
Nello specifico in questo caso si prendono dei topi e li si trattano con l’agente patogeno immunizzandoli, dopodiché si preleva la milza. Ciò che si è ottenuto sono delle cellule linfocitarie di topo capaci di produrre e rilasciare nel terreno di coltura degli anticorpi. Questo sarà un mix di anticorpi policlonali in quanto la milza è costituita da diverse linee B che producono diversi Ab monoclonali.
A questo punto i linfociti della milza vengono fusi con delle cellule tumorali (linee stabilizzate e immortalizzate di topo) derivanti da linfomi (tumori derivati da cellule del sistema ematopoietico). Fondendo questi due tipi di cellule ottengo l’ibridoma, ovvero un unico tipo cellulare che possiede sia la capacità derivante dai linfociti di produrre anticorpi, che la capacità di replicarsi in maniera indefinita derivante dalle cellule tumorali. Avrà comunque una coltura mista che produrrà una miscela di diversi Ab. 

Se prendessimo delle cellule primarie di linfociti o fibroblasti da un espianto di tessuto differenziato otterremmo delle cellule poco efficienti nella replicazione in piastra in quanto queste cellule sono abituate a stare in un tessuto, hanno bisogno di essere in tante per avere una cooperazione metabolica. Per questa ragione si dice che sono cellule non autonome.
Le cellule immortali invece non solo crescono in maniera indefinita ma hanno anche autonomia, sono bene adattate alle condizioni di coltura e possono crescere anche come singola cellula, ovvero possono clonare.
Se predo una piastra a pozzetti o Petri e semino queste cellule (se prendo una piastra Petri le semino molto rade, se prendo una multiwale da 90 pozzetti vado a diluire in modo tale da seminare 0-1 cell per pozzetto, non devo avere mai più di una cellula per pozzetto) le cellule immortalizzate crescono e formano dei cloni. 

Prendo l’ibridoma, semino le cellule dell’ibridoma, che hanno la caratteristica i produrre Ab e di clonare, o in piastre o in multiwale e poi amplifico i singoli cloni. A questo punto ogni clone avrà la caratteristica di produrre l’anticorpo di una sola delle linee B presenti nella milza dell’animale che ho utilizzato per la fusione. Quindi ho tanti cloni, ciascuno dei quali produce un anticorpo monoclonale diretto contro un diverso epitopo.

NB. Ovviamente prima di clonare le cellule si devono selezionare soltanto gli ibridi. Le parentali di un tipo non crescono a lungo termine perché sono cellule mortali, quindi le cellule primarie della milza si eliminano facilmente. Per eliminare le cellule parentali degli ibridomi si usa un terreno selettivo, HAT di cui parleremo dopo. 





Ciascuna coltura produrrà un anticorpo monoclonale diverso che dovrò caratterizzare per poi decidere quale mi serve per i miei scopi.

L’antigene con cui immunizzo il topo può essere una cellula intera, una membrana, un microorganismo. Si usano degli adiuvanti per l’immunizzazione. Si fa una titolazione dell’anticorpo presente nel siero e poi si preleva la milza dopo due settimane. 
Le cellule della milza vengono poi fatte fondere con cellule di mieloma che presentano la mutazione HGPRT- (mancano dell’enzima HGPRT). Questo enzima è normalmente responsabile della capacità della cellula di prelevare l’8-azaguanina, un analogo della guanina e un potente mutageno citotossico, dal terreno di crescita. Questa caratteristica serve per selezionare le cellule ibride.
Le cellule del mieloma sono dunque cellule immortali HGPRT- (meno).

Gli ibridomi saranno ottenuti tramite la fusione di cellule che producono Ab e di cellule che sono immortali e HGPRT-. Il terreno di selezione utilizzato è HAT, e qui sopravvivono solo le cellule HGPRT+. 
Perché le cellule HGPRT- muoiono? Perché il terreno HAT contiene un inibitore della sintesi endogena dei nucleotidi. HAT sta per hipoxantina (precursore purine) - aminopterina (inibitore dhfr) - timidina (precursore pirimidine); l’aminopterina o ametopterina è un potente inibitore della deidrofolato reduttasi, ovvero della via di sintesi endogena del DNA. In presenza di terreno HAT le cellule devono essere capaci di prelevare i precursori dal terreno. Le cellule di mieloma non sono capaci di prelevare dal terreno le basi puriniche, perché hanno la mutazione. Quindi nel terreno seleziono le cellule HGPRT- e TK - .
Tramite questo terreno posso dunque eliminare le cellule di mieloma che non si sono fuse, mentre quelle che si saranno fuse formando l’ibridoma avranno per complementazione il gene HGPRT della cellula donatrice della milza, e saranno quindi capace di crescere in questo terreno selettivo.

RICAPITOLANDO: ho eliminato il parentale 1 perché sono cellule primarie, il 2 perché ho messo l’inibitore della sintesi endogena, quindi dipende dalla presenza dell’enzima, la presenza dell’enzima gli deriva dalla fusione. Solo le cellule fuse potranno sopravvivere in questo terreno selettivo. 




Riassumendo il sistema HAT:
HAT:  HIPOXANTINA (PRECURSORE PURINE) 
		AMINOPTERINA (INIBITORE DHFR)
		TIMIDINA (PRECURSORE PIRIMIDINE)

    • AMINOPTERINA: 
        ◦ inibitore DHFR – non avviene la sintesi de novo delle basi. L’enzima DHFR, attraverso questa serie di reazioni porta alla formazione dell’acido N5, N10 metilen-tetraidrofolico, che è il maggior donatore di metili per la formazione di precursori per la sintesi del DNA. Ecco perché la presenza di questa molecola inibisce la sintesi del DNA. 
        ◦ viene utilizzata la via di salvataggio: sono indispensabili gli enzimi timidina chinasi (TK) per l’uptake delle pirimidine e l’enzima ipoxantina-guanina-fosfo-ribosil-transferasi (HGPRT) per l’uptake delle purine.
        ◦ L’aminopterina è la stessa molecola del metotrexato o metotrexate, uno dei più diffusi agenti antiblastici. Questo è un agente antitumorale perché blocca la crescita delle cellule inibendpone la sintesi del DNA (molecola molto usata nella chemioterapia).


Nb: si formeranno anche ibridi omocellulari milza-milza, ma questi moriranno in quanto cellule primarie non immortali.
...
Anticorpi monoclonali nella terapia dei tumori: la cellula tumorale viene utilizzata per immunizzare il topo, si producono degli Ab contro l’antigene tumorale, ma quello specifico del paziente. In questo modo si può attivare la risposta immunitaria contro la cellula tumorale richiamando le cellule NK, o associando all’anticorpo delle molecole terapeutiche. 
Fino ad ora abbiamo prodotto anticorpi monoclonali di topo, ma è evidente che se lo scopo è terapeutico è interessante poter produrre anticorpi monoclonali umani. Ma non è facile. Non si può immunizzare un uomo per fargli produrre anticorpi. Si fanno i cosiddetti anticorpi umanizzati.
Un anticorpo prodotto da una cellula animale diversa da quella umana, non viene accettato dal nostro organismo, viene trattato come non-self e contro di esso si scatena una risposta immunitaria. In questo caso devo cercare di farlo passare per self: si fanno degli anticorpi ibridi con una parte costante umana e una parte variabile di topo. 
Le difficoltà tecniche sono tante, non ci sono linee di mieloma adeguate, le cellule B umane possono essere immortalizzate ma perdono la capacità di produrre anticorpi, perché ovviamente non posso fare un trattamento in vivo, devo trattare colture cellulari e la coltura cellulare non produce anticorpi a lungo termine. Inoltre è difficile ottenere cellule B umane attivate dall’antigene. Per questo non si agisce manipolando gli anticorpi direttamente ma si agisce a livello del DNA di topo in modo che le cellule produttrici sintetizzino anticorpi con le porzioni variabili murine e le porzioni costanti umane. Si fa sostanzialmente una modificazione genetica del DNA di topo facendo in modo che sintetizzino anticorpi ibridi, non è la porzione variabile quella che ci interessa, è quella costante (che infatti è umana).
La porzione variabile è quella che riconosce l’anticorpo specifico, la porzione costante è quella che verrebbe riconosciuta come non self. Si tratta di una modificazione genetica dei geni che nel topo codificano per le immunoglobuline tale per cui si producono degli Ab ibridi umanizzati.
Anticorpi monoclonali umani si possono ottenere producendo topi transgenici nei quali i geni che codificano le catene leggere e pesanti delle Ig di topo sono stati inattivati e sono stati introdotti al loro posto dei geni che codificano le catene leggere e pesanti umane. 
In questo modo si ottiene un gene che codifica un anticorpo specifico, ma con un impianto anticorpale da Ig umana


Naturalmente in questo processo la cosa più complicata è fare la modificazione genetica della cellula ricevente che verrà utilizzata per la produzione di questi Ab umanizzati.
Per gli anticorpi monoclonali umani viene fatta una trasformazione con geni umani. In realtà la cosa diversa in questo approccio, rispetto a quello visto prima, è che nel primo lavoro venivano modificate la cellula dell’ibridoma lavorando in coltura cellulare, mentre in questo caso vengono costruiti dei topi transgenici capaci di produrre già Ig umanizzate. L’effetto comunque è lo stesso.
